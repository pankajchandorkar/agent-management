...
const AreaAutocomplete = forwardRef((props, ref) => {
    ...
    const areaOptions = [
        { area: 'Swargate', areaId: 1 },
        { area: 'Hirjewadi Bridge', areaId: 2 },
        { area: 'Chandni Chowk', areaId: 3 },
    ...
    useEffect(() => {
        if (selectedValues.length > 0) {
            ...
            if (selectedValues.length > 0) {
                preSelectedValues = areaOptions.filter((s) => selectedValues.indexOf(s.areaId) >= 0);
